  ...
  <div class="card">
    ...
    <div v-for="k in keys" :key="k.file" class="grp">
      <div style="display:flex;justify-content:space-between;align-items:center">
        <div>
          ...
          <div style="font-size:12px;color:#64748B;font-family:monospace">{{ k.exists ? k.prefix : '（未设置）' }}</div>
        </div>
    ...
    <div v-if="editing" class="msg ok" style="margin-top:16px">
      ...
      <div style="display:flex;gap:8px;margin-top:8px">
        ...
        <button class="btn btn-sm" style="background:#2a3a4a;color:#94A3B8" @click="editing=null">取消</button>
      </div>
