...
function normalizeLoggingConfig(input: LoggingConfig = {}) {
...
function writeLoggingConfig(data: LoggingConfig) {
...
function parseLogLine(item: RawLogItem | string, index): LogEntry {
...
function buildLogFilterKey(options: LogFilterOptions = {}, limit) {
...
function getFilteredLogEntries(options: LogFilterOptions = {}) {
