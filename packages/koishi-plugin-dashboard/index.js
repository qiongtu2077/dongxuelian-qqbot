...
const FEATURES_DATA = [
    ...
    },
    {
        ...
        detail: '读取今天的消息缓存，筛选出 @你（你的 QQ 号）的消息，按时间倒序列出。支持定位消息引用目标消息，可点击跳转；失败时回退上下文。@后没有文字的纯 @ 消息也会被记录。需要群在白名单内。',
        usage: '谁艾特我\n谁@我\n定位消息 <编号>',
        related: ['unbounded-whitelist', 'ai-cache'],
    },
    {
    ...
    },
    {
        ...
        title: '白名单与黑名单管理',
        summary: '管理 AI 回复范围',
        detail: '群聊 AI 白名单：只有白名单内的群才会触发 AI 主动回复（包括随机回复和 @ 回复）。用户黑名单：黑名单用户的发言不会被 AI 处理。视频黑名单：控制哪些群不触发视频解析。群聊昵称黑名单：控制哪些群禁用昵称绑定和 at 昵称。解除上限群白名单是另一个独立的高级功能白名单。',
        usage: '群聊AI白名单添加 <群号>\n用户黑名单添加 <QQ号>\n视频黑名单添加群 <群号>\n群聊昵称黑名单添加 <群号>',
...
const COMMANDS_DATA = [
    { category: '常用', commands: [
            ...
            { cmd: '东雪莲复读开 / 关 / 状态', desc: '切换复读模式（群管理员/群主）' },
            { cmd: '今日情绪', desc: '查看今日群聊情绪分析' },
            { cmd: '群聊日报 / 群聊详细日报', desc: '生成群聊日报' },
            { cmd: '谁艾特我 / 谁@我', desc: '查看今天谁 @了你' },
        ] },
    { category: '人格', commands: [
            { cmd: '东雪莲我的人格 / 东雪莲人格查看', desc: '查看你当前的个性（用户级）' },
            { cmd: '东雪莲人格切换 <名称>', desc: '切换你的个性（用户级）' },
            { cmd: '东雪莲人格列表', desc: '查看可用个性列表' },
            { cmd: '东雪莲人格重置', desc: '重置为默认个性（用户级）' },
            { cmd: '东雪莲群人格', desc: '查看群个性（群管理员/群主）' },
            { cmd: '东雪莲群人格切换 <名称>', desc: '切换群个性（群管理员/群主）' },
            { cmd: '东雪莲群人格重置', desc: '重置群个性（群管理员/群主）' },
            { cmd: '东雪莲测试开 / 关', desc: '切换测试模式' },
    ...
    { category: '记忆', commands: [
            { cmd: '记住xxx', desc: '直接写入记忆' },
            { cmd: '东雪莲忘记我', desc: '清空 AI 对你的记忆（需二次确认）' },
            { cmd: '东雪莲清空群记忆', desc: '清空整个群的记忆（群管理员/群主）' },
            { cmd: '东雪莲群记忆定时 <小时>', desc: '设置定时清空群记忆（群管理员/群主）' },
        ] },
    { category: '集合与昵称', commands: [
            { cmd: '@A用户 昵称 名称A', desc: '为用户 A 设置昵称' },
            { cmd: '查看昵称 名称A / 谁是 名称A', desc: '查看昵称对应的用户' },
            { cmd: '查看成员 @A用户', desc: '查看用户的集合成员' },
            { cmd: '查看全部昵称', desc: '查看所有昵称' },
            { cmd: '创建集合 集合A @A @B', desc: '创建集合' },
            { cmd: '集合添加 集合A @A', desc: '向集合添加成员' },
            { cmd: '集合删除 集合A @A', desc: '从集合删除成员' },
            { cmd: '查看集合 集合A / 集合列表 / 查看全部集合', desc: '查看集合内容' },
            { cmd: '复制集合 A B / 合并集合 A B', desc: '集合操作' },
            { cmd: '集合交集 A B / 集合并集 A B / 集合差集 A B', desc: '集合运算' },
            { cmd: 'at集合A / at名称A', desc: '批量@集合或昵称对应用户' },
        ] },
    { category: '群聊主动回复', commands: [
            { cmd: '东雪莲群聊AI概率查看', desc: '查看当前群 AI 回复概率' },
            { cmd: '东雪莲群聊AI概率设置X%', desc: '设置 AI 回复概率' },
            { cmd: '东雪莲群聊AI概率重置', desc: '重置为默认概率' },
            { cmd: '群聊AI白名单查看', desc: '查看 AI 白名单' },
            { cmd: '群聊AI白名单添加 群号', desc: '添加群到 AI 白名单' },
            { cmd: '群聊AI白名单删除 群号', desc: '从 AI 白名单移除群' },
        ] },
    ...
    { category: '抓取原始事件', commands: [
            { cmd: 'AI抓事件', desc: '开始抓取原始事件' },
            { cmd: 'AI抓事件查看', desc: '查看抓取的事件' },
            { cmd: 'AI抓事件取消', desc: '取消事件抓取' },
        ] },
    { category: '敏感话题检测', commands: [
            { cmd: '敏感话题检测开', desc: '开启检测（群管理员/群主）' },
            { cmd: '敏感话题检测关', desc: '关闭检测（群管理员/群主）' },
            { cmd: '敏感话题检测查看', desc: '查看检测状态' },
            { cmd: '敏感话题处理者添加 <QQ号>', desc: '添加通知人' },
            { cmd: '敏感话题处理者删除 <QQ号>', desc: '删除通知人' },
            { cmd: '敏感话题处理者查看', desc: '查看通知人列表' },
        ] },
    { category: '白名单黑名单管理', commands: [
            { cmd: '用户黑名单添加 <QQ号>', desc: '添加到用户黑名单' },
            { cmd: '用户黑名单删除 <QQ号>', desc: '从用户黑名单移除' },
            { cmd: '用户黑名单查看', desc: '查看用户黑名单' },
            { cmd: '解除上限群白名单添加 <群号>', desc: '添加到解除上限群白名单' },
            { cmd: '解除上限群白名单删除 <群号>', desc: '从解除上限群白名单移除' },
            { cmd: '解除上限群白名单查看', desc: '查看解除上限群白名单' },
            { cmd: '视频黑名单添加群 <群号>', desc: '添加群到视频黑名单' },
            { cmd: '视频黑名单删除群 <群号>', desc: '从视频黑名单移除群' },
            { cmd: '视频黑名单查看', desc: '查看视频黑名单' },
            { cmd: '群聊昵称黑名单添加 <群号>', desc: '禁用指定群的昵称与 at 昵称功能' },
            { cmd: '群聊昵称黑名单删除 <群号>', desc: '恢复指定群的昵称与 at 昵称功能' },
            { cmd: '群聊昵称黑名单查看', desc: '查看昵称黑名单群' },
        ] },
];
module.exports = { name, apply, FEATURES_DATA, COMMANDS_DATA };
