...
function handleGetResourceMode(req, res) {
    try {
...
function handlePostResourceMode(req, res) {
    if (!requireAdmin(req, res))
        return;
    collectBody(req, res, (body) => {
        try {
...
module.exports = { routes, buildResourceStatus, sanitizeTask, collectMemoryHistory, normalizeMemoryRange, getCachedMemoryHistory, collectDiskUsage, getCachedDiskUsage };
