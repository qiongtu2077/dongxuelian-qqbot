...
declare function normalizeFallbackChains(value: unknown, customProviders?: CustomProviderConfig[]): FallbackChains;
...
declare function handlePutApiConfigTransaction(req: IncomingMessage, res: ServerResponse): void;
...
declare const _default: {
    routes: {
        ...
        'PUT /dashboard/api/api-config/transaction': typeof handlePutApiConfigTransaction;
    ...
    normalizeFallbackChains: typeof normalizeFallbackChains;
};
export = _default;
