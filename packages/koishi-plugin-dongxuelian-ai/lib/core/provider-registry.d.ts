...
declare function resolveProviderApiKey(providerId: string, fallbackKey: string): Promise<string>;
declare function resolveProviderApiKeySync(providerId: string, fallbackKey: string): string;
