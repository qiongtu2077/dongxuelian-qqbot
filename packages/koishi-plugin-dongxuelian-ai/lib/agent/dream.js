 ...
 */
const { DASHBOARD_MEMORY_DIR, DAILY_DIR, DREAM_SIZE_THRESHOLD, submitAgentMemoryCompactionTask, getDailyTotalSize, getDreamStatus: getMemoryDreamStatus, getLongTermFile, readLongTermFile, safeUserId, } = require('../resource-workers/memory-worker');
...
async function runDreamIfNeeded(userId) {
    ...
    if (totalSize < DREAM_SIZE_THRESHOLD)
        return null;
