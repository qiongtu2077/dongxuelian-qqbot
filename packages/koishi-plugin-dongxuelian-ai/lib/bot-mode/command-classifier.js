...
function classifyCommand(input = {}) {
    ...
    if (isDailyCommand(plain))
        return 'daily_command';
    if (isStatusCommand(plain))
        return 'status_command';
    if (isAgentCommand(plain))
