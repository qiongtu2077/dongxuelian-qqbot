...
function getFlowErrorMessage(error) {
...
async function handleChatToolFlow({ reply, messages = [], options = {}, cleanInput = '', session, currentUserId = '', channelKey = '', activeFileContext = {}, fileFollowupState = {}, chatTools = null, callModel, } = {}) {
    if (typeof callModel !== 'function')
        throw new TypeError('callModel is required');
