...
async function runCoreContracts(context) {
  ...
  const syntaxFiles = [
    ...
    path.join(LIB, 'commands', 'locate-command.js'),
    ...
    path.join(LIB, 'lifecycle', 'locate-snapshot.js'),
