...
const shimToReal = {
  ...
  'expression-learner': 'behavior/expression/expression-learner',
  'expression-pool-store': 'behavior/expression/expression-pool-store',
  'expression-abstractor': 'behavior/expression/expression-abstractor',
  'expression-shadow-router': 'behavior/expression/expression-shadow-router',
