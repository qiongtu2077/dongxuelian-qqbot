...
async function renderEmotionImage(analysis: EmotionAnalysis, stats: EmotionStats, history: EmotionHistoryItem[] = []): Promise<unknown> {
  return renderHtmlToImage(renderEmotionHtml(analysis, stats, history))
}

export = { renderEmotionHtml, renderEmotionImage }
