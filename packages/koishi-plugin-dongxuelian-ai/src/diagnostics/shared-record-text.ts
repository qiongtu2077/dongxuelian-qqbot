 ...
 * 状态: 无状态。
 */
const { normalizeText, stripMentions } = require('../core/utils') as typeof import('../core/utils')
...
function resolveSharedRecordText(plain: string, analyzed: AnalyzedMessage = {}): string {
