...
function countActiveBackgroundTasks(kind: string, matcher: (task: ResourceTaskLike) => boolean): number {
...
function submitExpressionHarvestTask(options: ExpressionHarvestSubmissionOptions = {}): BackgroundSubmissionResult {
