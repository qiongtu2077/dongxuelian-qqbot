...
function buildPlanSystemPrompt(plan?: PromptPlan | null): string {
  const lines = [
...
function buildPlanCreatePrompt(userMessage: unknown = ''): string {
  return [
...
export = { buildPlanSystemPrompt, buildPlanCreatePrompt }
