...
const { assertNewAgentPathInsideRoots, assertExistingAgentPathInsideRoots, assertNotWriteBlockedBasename } = require('../path-guard') as typeof import('../path-guard')
...
export = {
  ...
  async execute(params: AppendFileParams = {}): Promise<string> {
