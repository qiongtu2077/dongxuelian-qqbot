...
function queueAnalyzeFile(channelKey: string, messageId: string, entry: FileEntryLike, userId = ''): string {
...
export = {
  ...
  async execute(params: AnalyzeFileParams = {}, context: AnalyzeFileContext = {}): Promise<string> {
