...
interface ProgrammaticShellGuardRule {
  id: string
  sev: ShellGuardSeverity
  desc: string
}
...
interface ShellGuardCategoryMeta {
  label: string
  description: string
}
...
// 类别1：数据销毁
// ============================================================
const DATA_DESTRUCTION: ShellGuardRule[] = [
...
// 类别2：系统破坏
// ============================================================
const SYSTEM_DESTRUCTION: ShellGuardRule[] = [
...
// 类别3：代码执行
// ============================================================
const CODE_EXECUTION: ShellGuardRule[] = [
...
// 类别4：网络滥用
// ============================================================
const NETWORK_ABUSE: ShellGuardRule[] = [
...
// 类别5：敏感文件访问
// ============================================================
const SENSITIVE_FILE: ShellGuardRule[] = [
...
// 类别6：权限提升
// ============================================================
const PRIVILEGE_ESCALATION: ShellGuardRule[] = [
...
// 类别7：Shell 规避技术
// ============================================================
const SHELL_EVASION: ShellGuardRule[] = [
...
// ============================================================
function checkBacktickInjection(cmd: string): ProgrammaticShellGuardRule | null {
  let inSingle = false
  let inDouble = false
...
// ============================================================
function checkBackslashWhitespace(cmd: string): ProgrammaticShellGuardRule | null {
  let inSingle = false
  let inDouble = false
...
// 所有规则合并
// ============================================================
const ALL_REGEX_RULES: ShellGuardRule[] = [
  ...DATA_DESTRUCTION,
  ...SYSTEM_DESTRUCTION,
  ...CODE_EXECUTION,
  ...NETWORK_ABUSE,
...
const ALL_PROGRAMMATIC_CHECKS: Array<(cmd: string) => ProgrammaticShellGuardRule | null> = [
  checkBacktickInjection,
  checkBackslashWhitespace,
]

const CATEGORY_META: Record<string, ShellGuardCategoryMeta> = Object.freeze({
...
const CATEGORY_RULES: Record<string, Array<ShellGuardRule | ProgrammaticShellGuardRule>> = Object.freeze({
  DATA_DESTRUCTION,
  SYSTEM_DESTRUCTION,
  CODE_EXECUTION,
  NETWORK_ABUSE,
 ...
 */
function checkShellCommand(command: string): ShellGuardResult {
  if (!command || typeof command !== 'string') {
    return { violations: [], blocked: false, summary: '' }
  }

  const violations: ShellGuardViolation[] = []
...
function listShellGuardRules(): ShellGuardCategoryInfo[] {
...
function summarizeShellCommand(command: string = '', max: number = 220): string {
