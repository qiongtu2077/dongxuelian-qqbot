 ...
 */
const { MIMORIUM_KEY_FILE, TTS_TEMP_DIR } = require('../../core/constants') as typeof import('../../core/constants')
const { readTextFile } = require('../../core/utils') as typeof import('../../core/utils')
