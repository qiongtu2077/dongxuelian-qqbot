...
const { getTaskQueueSummary } = require('../resource-workers/task-store') as typeof import('../resource-workers/task-store')
const { getMediaBackpressureStatus } = require('../media/backpressure/media-queue') as typeof import('../media/backpressure/media-queue')
...
// 生成固定资源状态文本，不调用模型。
function buildResourceStatusReply(): string {
