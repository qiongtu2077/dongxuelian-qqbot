...
const ALLOWED_REQUIRE_CHANGES = {
  ...
  'chat/chat-tools.js': { added: ['./chat-tool-policy', '../agent/safety', '../agent/pending', '../media/backpressure/media-queue', '../resource-scheduler/admission'], removed: ['../media/image/image-analyzer', '../routing/reminder-route'] },
  'chat/chat-tool-flow.js': { added: ['./file-followup-evidence'], removed: ['../media/file/file-followup-guard'] },
  ...
  'lifecycle/plugin-lifecycle.js': { added: ['../persona/skills/skills-loader', '../resource-workers/result-notifier', '../resource-workers/worker-supervisor'], removed: ['../chat'] },
  'lifecycle/startup-schedulers.js': { added: ['../daily-precompute/daily-slot-planner', '../daily-precompute/precompute-status'] },
  'chat.js': { added: ['./media/file/file-followup-state'], removed: ['./media/file/file-followup-guard'] },
  'media/file/file-followup-guard.js': { added: ['./file-followup-state', '../../chat/file-followup-evidence'], removed: ['./file-store', '../../agent/tools/analyze-file', './file-safety'] },
  ...
  'mcp/local-server.js': { added: ['../media/file/file-followup-state', '../resource-common/files', '../resource-gate/gate', '../resource-scheduler/admission'], removed: ['../agent/tools/analyze-file', '../media/file/file-followup-guard'] },
  ...
  'persona/persona-profile.js': { added: ['./persona-profile-sources'] },
